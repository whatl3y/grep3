...
class MatchupAnalyzer:
    ...
    def analyze(
        ...
        if team_stats.empty:
            console.print("[red]No team data available. Run 'ncaa-predict update-data' first.[/red]")
            return None
        ...
        if season is None:
            ...
            if current_season in team_features["season"].values:
                ...
                console.print(f"[yellow]Run 'ncaa-predict update-data' to fetch current season data.[/yellow]")
    ...
    def print_analysis(self, analysis: dict):
        ...
        console.print("NCAA BASKETBALL PREDICTION".center(65), style="bold white")
        console.print("═" * 65, style="bold blue")
        console.print()
        ...
        if pred.get("_fallback"):
            console.print()
            console.print("[yellow]⚠ Using simplified prediction (model not trained). Run 'ncaa-predict train' for better accuracy.[/yellow]")
