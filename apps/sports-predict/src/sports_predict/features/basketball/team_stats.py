"""Team feature building for basketball model training."""
...
@ComponentRegistry.register_feature_builder(League.NCAAB)
class BasketballFeatureBuilder:
    """Build feature vectors for basketball teams and matchups.

    This feature builder is registered for the NCAAB league and creates
    basketball-specific features including efficiency ratings, pace,
    ...
    def __init__(self, league: League = League.NCAAB):
        ...
        Args:
            league: The league this builder is for (default: NCAAB)
        """
        self.league = league
