...
from ..core.sport import League, get_current_season as core_get_current_season
...
# Cache directory for per-season data (legacy, for NCAAB)
...
@ComponentRegistry.register_scraper(League.NCAAB)
class NCAADataScraper:
    """Scrapes NCAA basketball data from Sports-Reference.com.

    This scraper is registered for the NCAAB league and fetches data from
    Sports-Reference.com including team statistics and game logs.
    """

    def __init__(self, league: League = League.NCAAB, delay: float = SCRAPE_DELAY_SECONDS):
        self.league = league
        self.delay = delay
        ...
        # Set up league-specific cache directory
