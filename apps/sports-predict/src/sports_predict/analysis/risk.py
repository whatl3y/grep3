...
@ComponentRegistry.register_risk_analyzer(League.NCAAB)
class RiskAnalyzer:
    """
    Analyze risk factors and quantify prediction uncertainty for basketball.
    ...
    def __init__(self, league: League = League.NCAAB):
        """Initialize the basketball risk analyzer.

        Args:
            league: The league (NCAAB for basketball)
        """
        self.league = league
