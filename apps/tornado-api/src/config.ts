...
const appName = process.env.APP_NAME || "@grep3/tornado-api";
...
export default {
  ...
  relayFeePercentage: process.env.RELAY_FEE_PERCENTAGE || "0.35", // 0.35% (0.0035)
  relayFeeMax: process.env.RELAY_FEE_MAX || "1000",
  relayFeeMin: process.env.RELAY_FEE_MIN || "0.002",
  withdrawalPkey: process.env.WITHDRAWAL_PK,
  ...
  tornadoDeployments: {
    ...
    netId5: {
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/goerli-tornado-subgraph",
    },
    netId56: {
      relayFeeMax: "0.4",
      relayFeeMin: "0.01",
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/bsc-tornado-subgraph",
    },
    netId100: {
      xdai: {
        instanceAddress: {
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/xdai-tornado-subgraph",
    },
    netId137: {
      matic: {
        instanceAddress: {
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/matic-tornado-subgraph",
    },
    netId42161: {
      relayFeeMax: "0.4",
      relayFeeMin: "0.01",
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/arbitrum-tornado-subgraph",
    },
    netId43114: {
      avax: {
        instanceAddress: {
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/avalanche-tornado-subgraph",
    },
    netId10: {
      eth: {
        instanceAddress: {
      ...
      subgraph:
        "https://api.thegraph.com/subgraphs/name/tornadocash/optimism-tornado-subgraph",
    },
  },
} as any;
